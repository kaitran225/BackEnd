...
public class ProgramController {
    ...
    public ResponseEntity<?> getPrograms() {
        return ResponseEntity.ok("List of programs");
    }
    ...
    @Operation(summary = "Get program location", description = "Returns the location of a specific program.")
    ...
    @Operation(summary = "Get enrolled programs", description = "Returns a list of enrolled programs.")
    @GetMapping("/programs/enrolled")
    public ResponseEntity<?> getEnrolledPrograms() {
        return ResponseEntity.ok("List of enrolled programs");
    }

    @Operation(summary = "Submit feedback", description = "Submits feedback for a specific program.")
    ...
    @Operation(summary = "Get program full details", description = "Returns full details of a specific program.")
    ...
    // Students only
    @Operation(summary = "Get enrolled programs for a student", description = "Returns a list of enrolled programs for a specific student.")
    ...
    // Very low priority
    @Operation(summary = "Approve cancellation request", description = "Approves a cancellation request for a specific program.")
    ...
    @Operation(summary = "Send program announcement", description = "Sends an announcement for a specific program.")
